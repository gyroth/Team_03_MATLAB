...
% track of the position and force vector of the tip. It uses the camera
% attached to the robot to identify the objects and their colors, then
% moves the arm to pick one up. It then measures the force generated by the
% object and places it in a pre-determined location according to the
% object's color and weight.
%
%
clear
clc
...
% Declare PID values for each joint of the arm
kP1 = 0.0001;
kI1 = 0;
kD1 = 0;
    ...
    while(1)
        switch(states)
            ...
            case 2 % What is the obj location
                ...
                objectLoc = objectInfo(1:3);
                objectLoc{1} = objectLoc{1}+20 - (bh*(objectLoc{1}+30)/ch);
            ...
            case 6 % pick it up
                ...
                %Moves the arm to the weight to pick it up
            ...
            case 7 %"weigh object"
                ...
                first = playAudio(first,objectColor{1});
                pause(.5);
            ...
            case 8 %"heavy"
                ...
                elseif objectColor{1} == "green"
                 ...
                 %move the object to color specific point towards us outside camera bounds
                switch color
                    case 1
